...
library(manipulate)
outcomes <- c(0:30)
manipulate(hist(sample(outcomes, n, replace = TRUE), breaks = seq(0,30,1), probability = TRUE, main = paste("Histogram of Outcomes of ", n, " Days of Listening", sep = ""), xlab = "Number of Calls", ylab = "Probability", xlim=c(0,30)), n = slider(0,10000, initial = 104, step = 100))
```
